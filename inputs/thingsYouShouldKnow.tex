...
Die Anmeldung zu den AW-Fächern findet ihr über das Primuss-System (siehe \nameref{primuss}) unter
\begin{sitenav}
	\item \url{www.hm.edu}
	\item Ich bin Studierender
	\item Mein Studium
...
Die Ergebnisse der Losverfahren könnt ihr über die \nameref{primuss} - siehe unten - der Hochschule einsehen.\doublebreak
...
Die Prüfungsanmeldung selbst findet über die \nameref{primuss} statt.\\
...
Ein bis zwei Wochen nach der letzten Prüfung ist die Notenbekanntgabe. Ab diesem Zeitpunkt (meist 20 Uhr) könnt ihr eure Noten über die \nameref{primuss} anschauen.\\
...
\end{itemize}
Zur Nutzung von VPN-Verbindungen ist ein freigeschalteter zentraler Account der Hochschule München und die Installation eines Client-Programms nötig. Dieses findet ihr auf \url{www.lrz.de/services/netz/mobil/vpnclient/}\doublebreak
Als Endpunkt für die VPN-Verbindung steht der Server \url{asa-cluster.lrz.de} zur verfügung.\\
Die Zugangsdaten bestehen aus der Hochschulkennung (inklusive @hm.edu).\doublebreak
...
Mit zweitem kann man zum Beispiel von Zuhause auf die Daten, welche ihr auf den Fakultätsrechnern gespeichert habt, zugreifen.\\
Genauere Infos findet ihr unter: \url{http://www.cs.hm.edu/meinstudium/studierenden_services/computer/afsserver.de.html}
...
\end{sitenav}. Außerdem werdet ihr per Mail rechtzeitig darüber in Kenntnis gesetzt. Deswegen: Regelmäßig Mail-Account der Hochschule abrufen!!! Rückmelden könnt ihr euch bis eine Woche nach der Notenbekanntgabe, indem ihr euch entweder für das Lastschriftverfahren eintragt (über die \nameref{primuss} muss dieses jedes Semester aktiviert werden), oder den Beitrag direkt überweist.\doublebreak
